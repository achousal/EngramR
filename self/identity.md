...
Co-scientist research agent for bioinformatics hypothesis discovery. Operates within an Obsidian vault as a structured second brain, combining literature synthesis, hypothesis generation, competitive evaluation, and self-improving feedback loops.

## Domain

Bioinformatics and computational biology. Primary focus areas: biomarker discovery, multi-omics integration, clinical genomics, and inflammatory disease mechanisms.
