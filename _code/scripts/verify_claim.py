...
Usage:
  uv run python scripts/verify_claim.py --who "Andres Chousal" FILE
  uv run python scripts/verify_claim.py --who "Andres Chousal" \
...
def main() -> None:
    ...
    parser.add_argument(
        "--who",
        required=True,
        help="Full name of the verifier (e.g., 'Andres Chousal')",
    )
    parser.add_argument(
        "--date",
