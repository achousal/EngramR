...
class VaultConfig:
    ...
    Attributes:
        ...
        api_url: Obsidian Local REST API base URL for this vault.
        api_key: Bearer token for the Obsidian API.
        port: Obsidian API port (informational; derived from api_url).
