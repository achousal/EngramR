"""Matplotlib/Seaborn theme anchored to _code/styles/PLOT_DESIGN.md.
...
_FALLBACK_SEX: dict[str, str] = {"Male": "#377EB8", "Female": "#E41A1C"}
_FALLBACK_DX: dict[str, str] = {"P-": "#4DAF4A", "P+": "#E41A1C"}
...
_FALLBACK_LABS: dict[str, list[str]] = {
    "elahi": [
        "#E41A1C",
        "#377EB8",
        "#4DAF4A",
...
# -- Color constants (ColorBrewer Set1, matching _code/styles/PLOT_DESIGN.md) ---

_SEM = _PALETTES.get("semantic", {})

SEX_COLORS: dict[str, str] = _SEM.get("sex", _FALLBACK_SEX)
DX_COLORS: dict[str, str] = _SEM.get("dx", _FALLBACK_DX)
...
LAB_PALETTES: dict[str, list[str]] = _PALETTES.get("labs", _FALLBACK_LABS)
...
def get_lab_palette(lab: str, n: int | None = None) -> list[str]:
    ...
    Args:
        lab: Lab name ("elahi", "chipuk", or "kuang"), case-insensitive.
...
def apply_research_theme(font_size: int = BASE_FONT_SIZE) -> None:
    ...
    Sets rcParams to match _code/styles/PLOT_DESIGN.md: classic base, bold titles,
