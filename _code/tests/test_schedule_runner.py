...
class TestExtractWikilinkStems:
    def test_list_of_wikilinks(self):
        items = ["[[EXP-001-ceramide]]", "[[EXP-002-lps]]"]
        assert _extract_wikilink_stems(items) == ["EXP-001-ceramide", "EXP-002-lps"]

    def test_single_string(self):
        assert _extract_wikilink_stems("[[H-AD-004b]]") == ["H-AD-004b"]
...
class TestMatchReminders:
    def test_matches_by_experiment_id(self):
        ...
        fm = {
            ...
            "linked_experiments": ["[[EXP-001-ceramide-plasmalogen-adni]]"],
            "linked_hypotheses": [],
        }
    ...
    def test_matches_by_project_tag(self):
        reminders = [
            ReminderBrief(date="2026-03-01", text="Check lps-inflammation counts"),
        ]
        fm = {
            "project_tag": "lps-inflammation",
            "linked_experiments": [],
            "linked_hypotheses": [],
        }
        matched = _match_reminders_to_project(reminders, fm)
