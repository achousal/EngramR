...
Generate publication-quality figures using the canonical research theme from _code/styles/PLOT_DESIGN.md.

## Theme specification
- Defined in: `_code/styles/PLOT_DESIGN.md` (vault root)
...
## Y-axis strategy (from _code/styles/PLOT_DESIGN.md)
...
- Font size: 14pt base (matching _code/styles/PLOT_DESIGN.md).
...
## Rationale
Visual communication -- consistent, publication-quality representation of data and results. Anchored to _code/styles/PLOT_DESIGN.md for reproducible aesthetics across all project outputs.
