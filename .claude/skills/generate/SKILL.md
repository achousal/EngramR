...
- `_code/src/engram_r/search_interface.py` -- unified search interface; dispatches to configured backends (PubMed, arXiv, Semantic Scholar, OpenAlex, etc.)
...
- Search configured literature backends (see ops/config.yaml research section) for papers relevant to the research goal.
...
- Literature grounding should cite source identifiers (PMIDs, arXiv IDs, URLs, as applicable to backend).
