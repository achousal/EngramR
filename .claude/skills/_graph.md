...
| `/literature` | PubMed, arXiv (via API) | `_research/literature/`, `_research/literature/_index.md` |
...
| `/plot` | user-provided data, `_code/styles/PLOT_DESIGN.md`, `_code/styles/STYLE_GUIDE.md` | user-specified output directory (PDF figures) |
