...
- If topic includes `--no-goals`: skip Step 6 (goals.md update), strip flag from topic
...
Skip this step entirely if `--no-goals` flag was present in the original arguments.
