...
|-------------------|----------|--------|-----------------|
| ## Mechanism | Mechanism claims -- causal assertions about biology | claim | The causal model: what causes what, through which pathway, why |
...
**Source attribution:** Each extracted claim gets `source: "[[hypothesis-id]]"` (e.g., `source: "[[H-AD-004b-ceramide-plasmalogen-ratio-v2]]"`). This creates bidirectional links: hypothesis -> claims via source footer, claims -> hypothesis via wiki-link body text.
