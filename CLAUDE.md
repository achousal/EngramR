...
**NEVER write directly to notes/.** All content routes through: inbox/ -> /reduce -> notes/. Direct writes skip quality gates. Exception: /seed creates single claims from conversation.
...
Supporting skills: /literature, /plot, /eda, /experiment, /project.
...
**Supporting Research**: /literature, /experiment, /eda, /plot, /project
